...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <span class="brand-text font-weight-light">{{ config('app.name', 'Flymel') }}</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
                <a href="{{route('admin.home')}}" class="nav-link {{(Request::is('admin/home') ? 'active' : '')}}">
                  <i class="fas fa-tachometer-alt nav-icon purple"></i>
                  <p>Dashboard</p>
                </a>
          </li>
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link                           {{(Request::is('admin/permissions') ? 'active' : '')}}
                                                                  ...
                                                                  {{(Request::is('admin/permissions/edit/*') ? 'active' : '')}}
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('permission.index')}}" class="nav-link {{(Request::is('admin/permissions') ? 'active' : '')}}
                                                                        {{(Request::is('admin/permissions/create') ? 'active' : '')}}
                                                                        {{(Request::is('admin/permissions/edit/*') ? 'active' : '')}}">
          ...
          <li class="nav-item">
                <a href="{{route('blog.index')}}" class="nav-link {{(Request::is('admin/blogs') ? 'active' : '')}}
                                                                  {{(Request::is('admin/blogs/create') ? 'active' : '')}}
                                                                  {{(Request::is('admin/blogs/edit/*') ? 'active' : '')}}">
          ...
          <li class="nav-item">
                <a href="{{route('news.index')}}" class="nav-link {{(Request::is('admin/news') ? 'active' : '')}}
                                                                  ...
                                                                  {{(Request::is('admin/news/edit/*') ? 'active' : '')}}">
                  <i class="fas fa-newspaper nav-icon teal"></i>
                  <p>News</p>
                </a>
          </li>
          <li class="nav-item has-treeview">
